...
Geosupport Desktop is not available for Mac but it can be used through a containerized environment like Docker. See the related projects section for links on how to do this.
...
- **PATH**: Add the *bin* directory of Geosupport to the *path*. Example: ``C:\Program Files (x86)\Geosupport Desktop Edition\bin``

Alternatively see the configuration section for other (easier) options on specifying a path to Geosupport.
